...
class BusinessOwnerRegisterWithPhoneNumber extends StatefulWidget {
  const BusinessOwnerRegisterWithPhoneNumber({super.key});

  @override
  State<BusinessOwnerRegisterWithPhoneNumber> createState() =>
      _BusinessOwnerRegisterWithPhoneNumberState();
}

class _BusinessOwnerRegisterWithPhoneNumberState
    extends State<BusinessOwnerRegisterWithPhoneNumber> {
