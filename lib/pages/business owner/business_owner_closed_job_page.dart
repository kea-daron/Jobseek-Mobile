...
class BusinessOwnerClosedJobPage extends StatelessWidget {
  const BusinessOwnerClosedJobPage({super.key});
  ...
  Widget _buildJobCard(BuildContext context, _ClosedJob job) {
    return Container(
  ...
  Widget _buildLogo(_ClosedJob job) {
    return Container(
      width: 48,
      height: 48,
      decoration: BoxDecoration(
